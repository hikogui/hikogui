...
void ImageWidget::drawBackingImage()
{
    ...
    path1.fill(linearMap, color , Draw::SubpixelOrientation::Unknown);

    auto path2 = Draw::Path();
    path2.addGlyph(glyph, { 30.0, 30.0 }, 8.0);
    path2.fill(linearMap, color, Draw::SubpixelOrientation::RedLeft);

    auto path3 = Draw::Path();
    path3.addGlyph(glyph, { 40.0, 30.0 }, 8.0);
    path3.fill(linearMap, color, Draw::SubpixelOrientation::RedRight);
