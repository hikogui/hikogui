...
TEST(SmallMap, Default) {
    ...
    ASSERT_EQ(items.push(10, 100), true);
    ASSERT_EQ(items.size(), 1);

    ASSERT_EQ(items.push(20, 200), true);
    ASSERT_EQ(items.size(), 2);

    ASSERT_EQ(items.push(10, 1000), true);
    ASSERT_EQ(items.size(), 3);

    ASSERT_EQ(items.push(30, 300), true);
    ASSERT_EQ(items.size(), 4);

    ASSERT_EQ(items.push(40, 400), false);
    ASSERT_EQ(items.size(), 4);
