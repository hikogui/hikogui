...
constexpr KeyboardVirtualKey to_KeyboardVirtualKey(int key_code, bool extended, KeyboardModifiers modifiers)
{
    switch (key_code) {
    ...
    case VK_RETURN: return extended ? KeyboardVirtualKey::NumpadEnter : KeyboardVirtualKey::Enter;
    ...
    case VK_DELETE: return extended ? KeyboardVirtualKey::NumpadDelete : KeyboardVirtualKey::Delete;
    case '0': return extended ? KeyboardVirtualKey::Numpad0 : KeyboardVirtualKey::_0;
    case '1': return extended ? KeyboardVirtualKey::Numpad1 : KeyboardVirtualKey::_1;
    case '2': return extended ? KeyboardVirtualKey::Numpad2 : KeyboardVirtualKey::_2;
    case '3': return extended ? KeyboardVirtualKey::Numpad3 : KeyboardVirtualKey::_3;
    case '4': return extended ? KeyboardVirtualKey::Numpad4 : KeyboardVirtualKey::_4;
    case '5': return extended ? KeyboardVirtualKey::Numpad5 : KeyboardVirtualKey::_5;
    case '6': return extended ? KeyboardVirtualKey::Numpad6 : KeyboardVirtualKey::_6;
    case '7': return extended ? KeyboardVirtualKey::Numpad7 : KeyboardVirtualKey::_7;
    case '8': return extended ? KeyboardVirtualKey::Numpad8 : KeyboardVirtualKey::_8;
    case '9': return extended ? KeyboardVirtualKey::Numpad9 : KeyboardVirtualKey::_9;
    ...
    case VK_NUMPAD0: return KeyboardVirtualKey::Numpad0;
    case VK_NUMPAD1: return KeyboardVirtualKey::Numpad1;
    case VK_NUMPAD2: return KeyboardVirtualKey::Numpad2;
    case VK_NUMPAD3: return KeyboardVirtualKey::Numpad3;
    case VK_NUMPAD4: return KeyboardVirtualKey::Numpad4;
    case VK_NUMPAD5: return KeyboardVirtualKey::Numpad5;
    case VK_NUMPAD6: return KeyboardVirtualKey::Numpad6;
    case VK_NUMPAD7: return KeyboardVirtualKey::Numpad7;
    case VK_NUMPAD8: return KeyboardVirtualKey::Numpad8;
    case VK_NUMPAD9: return KeyboardVirtualKey::Numpad9;
    case VK_MULTIPLY: return KeyboardVirtualKey::NumpadMultiply;
    case VK_ADD: return KeyboardVirtualKey::NumpadAdd;
    case VK_SUBTRACT: return KeyboardVirtualKey::NumpadSubtract;
    case VK_DECIMAL: return KeyboardVirtualKey::NumpadDecimal;
    case VK_DIVIDE: return KeyboardVirtualKey::NumpadDivide;
    ...
    case VK_OEM_PLUS: return extended ? KeyboardVirtualKey::NumpadAdd : KeyboardVirtualKey::Plus;
    case VK_OEM_COMMA: return KeyboardVirtualKey::Comma;
    case VK_OEM_MINUS: return extended ? KeyboardVirtualKey::NumpadSubtract : KeyboardVirtualKey::Minus;
    case VK_OEM_PERIOD: return extended ? KeyboardVirtualKey::NumpadDecimal : KeyboardVirtualKey::Period;
