...
def writeUnicodeData(filename, descriptions, compositions, decompositions):
    ...
    fd.write("#define HIXFILL HIXD{HIXGC::Cn, HIXGU::Other, HIXLB::AI, HIXWB::Other, HIXSB::Other, HIXEA::A, HIXSC::Common, HIXBC::ON, HIXBB::n, U'\\uffff', HIXDT::canonical, false, 0, 0, 0}\n")
