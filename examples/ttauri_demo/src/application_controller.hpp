...
#include "ttauri/GUI/gfx_system_delegate.hpp"
#include <memory>
#include <vector>
...
public:
    ...
    */
    virtual std::weak_ptr<tt::gfx_system_delegate> gfx_system_delegate(tt::application &self) noexcept {
        return weak_from_this();
    }

    std::optional<int> main(tt::application &self) override;

    void last_window_closed(tt::gfx_system &self) override;
};
