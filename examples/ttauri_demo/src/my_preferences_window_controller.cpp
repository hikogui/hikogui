...
void my_preferences_window_controller::init_audio_tab(tt::grid_layout_widget &grid) noexcept
{
    ...
    auto audio_device_selector = grid.make_widget<selection_widget>(
        "B1",
...
void my_preferences_window_controller::init_license_tab(tt::grid_layout_widget &grid) noexcept
{
    ...
    auto radio1 = grid.make_widget<radio_button_widget>("B3", l10n("Radio 1"), radioValue, 0);
    auto radio2 = grid.make_widget<radio_button_widget>("B4", l10n("Radio 2"), radioValue, 1);
    auto radio3 = grid.make_widget<radio_button_widget>("B5", l10n("Radio 3"), radioValue, 2);
