...
int tt_main(int argc, char* argv[])
{
    ...
    window.make_toolbar_widget<toolbar_tab_button_widget>(l10n("one"), value, 0);
    window.make_toolbar_widget<toolbar_tab_button_widget>(l10n("two"), value, 1);
    window.make_toolbar_widget<toolbar_tab_button_widget>(l10n("three"), value, 2);
    /// [Create three toolbar tab buttons]
