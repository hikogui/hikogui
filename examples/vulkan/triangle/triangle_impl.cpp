...
void TriangleExample::createPipeline()
{
    ...
    shaderStages[0].module = loadSPIRVShader(hi::URL{"resource:triangle_vulkan.vert.spv"});
    ...
    // Load binary SPIR-V shader
    shaderStages[1].module = loadSPIRVShader(hi::URL{"resource:triangle_vulkan.frag.spv"});
    // Main entry point for the shader
