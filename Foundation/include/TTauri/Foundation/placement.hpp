...
public:
    force_inline placement_ptr(nonstd::span<Byte> bytes, ssize_t &offset) {
...
template<typename T,typename Byte>
force_inline placement_ptr<T,Byte> unsafe_make_placement_ptr(nonstd::span<Byte> bytes, ssize_t &offset)
{
    return placement_ptr<T,Byte>(bytes, offset);
}

template<typename T,typename Byte>
force_inline placement_ptr<T,Byte> unsafe_make_placement_ptr(nonstd::span<Byte> bytes, ssize_t &&offset = 0)
{
...
template<typename T,typename Byte>
force_inline bool check_placement_ptr(nonstd::span<Byte> bytes, ssize_t offset = 0)
{
    return check_alignment<T>(bytes.data()) && (offset + sizeof(T) <= usize(bytes));
}

template<typename T,typename Byte>
force_inline placement_ptr<T,Byte> make_placement_ptr(nonstd::span<Byte> bytes, ssize_t &offset)
{
...
template<typename T,typename Byte>
force_inline placement_ptr<T,Byte> make_placement_ptr(nonstd::span<Byte> bytes, ssize_t &&offset = 0)
{
    ssize_t _offset = offset;
...
template<typename T,typename Byte>
force_inline placement_array<T,Byte> unsafe_make_placement_array(nonstd::span<Byte> bytes, ssize_t &offset, ssize_t n)
{
...
template<typename T,typename Byte>
force_inline placement_array<T,Byte> unsafe_make_placement_array(nonstd::span<Byte> bytes, ssize_t &&offset = 0)
{
...
template<typename T,typename Byte>
force_inline bool check_placement_array(nonstd::span<Byte> bytes, ssize_t offset, ssize_t n)
{
    return check_alignment<T>(bytes.data()) && (offset + (n * ssizeof(T)) <= ssize(bytes));
}

template<typename T,typename Byte>
force_inline bool check_placement_array(nonstd::span<Byte> bytes, ssize_t offset)
{
    return check_alignment<T>(bytes.data());
}

template<typename T,typename Byte>
force_inline placement_array<T,Byte> make_placement_array(nonstd::span<Byte> bytes, ssize_t &offset, ssize_t n)
{
...
template<typename T,typename Byte>
force_inline placement_array<T,Byte> make_placement_array(nonstd::span<Byte> bytes, ssize_t &&offset = 0)
{
    ssize_t _offset = offset;
