...
TEST(Tokenizer, ParseInteger1) {
    ...
    ASSERT_TOKEN_EQ(tokens[0], Operator, "++", v.begin() + 0);
    ASSERT_TOKEN_EQ(tokens[1], IntegerLiteral, "12345", v.begin() + 2);
    ASSERT_TOKEN_EQ(tokens[2], Operator, "++", v.begin() + 7);
...
TEST(Tokenizer, ParseDashedNumber) {
    ...
    ASSERT_TOKEN_EQ(tokens[2], Operator, "++", v.begin() + 12);
...
TEST(Tokenizer, ParseString1) {
    ...
    ASSERT_TOKEN_EQ(tokens[2], Operator, "++", v.begin() + 8);
...
TEST(Tokenizer, ParseLiteral) {
    ...
    auto tokens = parseTokens(v);
    ASSERT_TOKEN_EQ(tokens[0], Operator, "++", v.begin() + 0);
    ASSERT_TOKEN_EQ(tokens[1], Operator, ".", v.begin() + 2);
    ASSERT_TOKEN_EQ(tokens[2], Operator, "++", v.begin() + 3);
...
TEST(Tokenizer, ParseSlash) {
    ...
    auto tokens = parseTokens(v);
    ASSERT_TOKEN_EQ(tokens[0], Operator, "++", v.begin() + 0);
    ASSERT_TOKEN_EQ(tokens[1], Operator, "/", v.begin() + 3);
    ASSERT_TOKEN_EQ(tokens[2], Operator, "++", v.begin() + 5);
...
TEST(Tokenizer, ParseWhitespace) {
    ...
    auto tokens = parseTokens(v);
    ASSERT_TOKEN_EQ(tokens[0], Operator, "++", v.begin() + 0);
    ASSERT_TOKEN_EQ(tokens[1], Operator, "++", v.begin() + 7);
...
TEST(Tokenizer, ParseFQName) {
    ...
    ASSERT_TOKEN_EQ(tokens[1], Operator, ".", v.begin() + 8);
