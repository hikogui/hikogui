...
{
    vertexShaderModule = device.loadShader(URL("resource:GUI/pipeline_flat.vert.spv"));
    fragmentShaderModule = device.loadShader(URL("resource:GUI/pipeline_flat.frag.spv"));
