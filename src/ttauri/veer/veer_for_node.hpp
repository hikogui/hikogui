...
struct veer_for_node final: veer_node {
    ...
    veer_for_node(parse_location location, std::unique_ptr<expression_node> name_expression, std::unique_ptr<expression_node> list_expression) noexcept :
        veer_node(std::move(location)), name_expression(std::move(name_expression)), list_expression(std::move(list_expression)) {}
