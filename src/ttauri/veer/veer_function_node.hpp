...
struct veer_function_node final: veer_node {
    std::string name;
    ...
    veer_function_node(parse_location location, expression_post_process_context &context, std::unique_ptr<expression_node> function_declaration_expression) noexcept :
