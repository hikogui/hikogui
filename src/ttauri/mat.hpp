...
public:
    ...
    mat(float i00,
        ...
        float i23,
        float i33) :
        col0({i00, i01, i02, i03}), col1({i10, i11, i12, i13}), col2({i20, i21, i22, i23}), col3({i30, i31, i32, i33})
    {
    }
    ...
    struct S {
        ...
        explicit S(f32x4 rhs) noexcept : s(rhs)
        {
            tt_axiom(rhs.is_point());
        }

        S(float x, float y, float z = 1.0f) noexcept : s({x, y, z, 1}) {}
        ...
        {
            return rect{lhs.s * rhs.corner<0>(), lhs.s * rhs.corner<1>(), lhs.s * rhs.corner<2>(), lhs.s * rhs.corner<3>()};
        }
    ...
    struct T {
        ...
        explicit T(f32x4 rhs) noexcept : t(rhs)
        {
            tt_axiom(rhs.is_vector());
        }

        T(float x, float y, float z = 0.0f) noexcept : t({x, y, z}) {}
        ...
        {
            return rect{lhs.t + rhs.corner<0>(), lhs.t + rhs.corner<1>(), lhs.t + rhs.corner<2>(), lhs.t + rhs.corner<3>()};
        }
    ...
    struct T2 {
        ...
        T2(float x, float y) noexcept : t({x, y, 0.0f}) {}
    ...
    {
        return (lhs.col0 * rhs.xxxx() + lhs.col1 * rhs.yyyy()) + (lhs.col2 * rhs.zzzz() + lhs.col3 * rhs.wwww());
    }
    ...
    {
        return rect{lhs * rhs.corner<0>(), lhs * rhs.corner<1>(), lhs * rhs.corner<2>(), lhs * rhs.corner<3>()};
    }
    ...
    [[nodiscard]] friend mat operator~(mat const &rhs)
    {
        ...
        ttlet inv_col0 = ((t.col1.yxxx() * tmp_c5543) + (t.col1.zzyy() * tmp_c4221) + (t.col1.wwwz() * tmp_c3100)) * invdet;
        ...
        tmp_c4221 = -tmp_c4221;
        tmp_c3100 = -tmp_c3100;
        ttlet inv_col1 = ((t.col0.yxxx() * tmp_c5543) + (t.col0.zzyy() * tmp_c4221) + (t.col0.wwwz() * tmp_c3100)) * invdet;
        ...
        ttlet inv_col2 = ((t.col3.yxxx() * tmp_s5543) + (t.col3.zzyy() * tmp_s4221) + (t.col3.wwwz() * tmp_s3100)) * invdet;
        ...
        tmp_s4221 = -tmp_s4221;
        tmp_s3100 = -tmp_s3100;
        ttlet inv_col3 = ((t.col2.yxxx() * tmp_s5543) + (t.col2.zzyy() * tmp_s4221) + (t.col2.wwwz() * tmp_s3100)) * invdet;
    ...
    {
        return mat::T{aarect::_align(haystack, needle, alignment).offset() - needle.offset()};
    }
...
template<>
struct is_mat<mat> : std::true_type {
};
template<>
struct is_mat<mat::T> : std::true_type {
};
template<>
struct is_mat<mat::T2> : std::true_type {
};
template<>
struct is_mat<mat::S> : std::true_type {
};
