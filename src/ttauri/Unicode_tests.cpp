...
TEST(Unicode, UTF32toUTF8) {
    ASSERT_EQ(to_u8string(U"Hello World"s), u8"Hello World"s);

    ASSERT_EQ(to_u8string(U"\u0001"s), u8"\u0001"s);
    ASSERT_EQ(to_u8string(U"_\u0001_"s), u8"_\u0001_"s);
    ASSERT_EQ(to_u8string(U"\u0011"s), u8"\u0011"s);
    ASSERT_EQ(to_u8string(U"_\u0011_"s), u8"_\u0011_"s);
    ASSERT_EQ(to_u8string(U"\u0111"s), u8"\u0111"s);
    ASSERT_EQ(to_u8string(U"_\u0111_"s), u8"_\u0111_"s);
    ASSERT_EQ(to_u8string(U"\u1111"s), u8"\u1111"s);
    ASSERT_EQ(to_u8string(U"_\u1111_"s), u8"_\u1111_"s);
    ASSERT_EQ(to_u8string(U"\U00011111"s), u8"\U00011111"s);
    ASSERT_EQ(to_u8string(U"_\U00011111_"s), u8"_\U00011111_"s);
    ASSERT_EQ(to_u8string(U"\U00101111"s), u8"\U00101111"s);
    ASSERT_EQ(to_u8string(U"_\U00101111_"s), u8"_\U00101111_"s);
}
