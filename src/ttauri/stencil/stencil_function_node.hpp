...
struct stencil_function_node final: stencil_node {
    std::string name;
    ...
    stencil_function_node(parse_location location, formula_post_process_context &context, std::unique_ptr<formula_node> function_declaration_expression) noexcept :
