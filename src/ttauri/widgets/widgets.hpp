...
T &gui_window::make_widget(size_t column_nr, size_t row_nr, Args &&... args)
{
 ...
 */
template<typename T, typename... Args>
T &gui_window::make_widget(std::string_view address, Args &&...args)
{
...
T &gui_window::make_toolbar_widget(Args &&... args)
{
    tt_axiom(is_gui_thread());
    tt_axiom(widget);
