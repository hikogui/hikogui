...
public:
    ...
    explicit operator signed short () { return numeric_cast<signed short>(static_cast<signed long long>(*this)); }
    explicit operator signed char () { return numeric_cast<signed char>(static_cast<signed long long>(*this)); }
    ...
    explicit operator unsigned short () { return numeric_cast<unsigned short>(static_cast<signed long long>(*this)); }
    explicit operator unsigned char () { return numeric_cast<unsigned char>(static_cast<signed long long>(*this)); }
...
public:
    ...
    [[nodiscard]] friend std::string to_string(decimal x) noexcept {
        ...
        auto leading_zeros = (decimal_position - nonstd::ssize(s)) + 1;
        if (leading_zeros > 0) {
