...
[[nodiscard]] tt_no_inline constexpr char32_t utf8_to_utf32_fallback(char8_t c) noexcept
{
...
[[nodiscard]] inline std::u32string to_u32string(std::u16string_view rhs) noexcept {
    ...
    if (std::ssize(rhs) != 0 && rhs.front() == UnicodeReverseBOM) {
