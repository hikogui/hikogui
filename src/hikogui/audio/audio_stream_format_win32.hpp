...
hi_export [[nodiscard]] bool win32_use_extensible(audio_stream_format x) noexcept{
...
hi_export [[nodiscard]] WAVEFORMATEXTENSIBLE audio_stream_format_to_win32(audio_stream_format stream_format, bool extensible) noexcept{
...
hi_export [[nodiscard]] audio_stream_format audio_stream_format_from_win32(WAVEFORMATEXTENSIBLE const& wave_format){
...
hi_export [[nodiscard]] audio_stream_format audio_stream_format_from_win32(WAVEFORMATEX const& wave_format){
    auto r = audio_stream_format{};
