...
hi_export [[nodiscard]] speaker_mapping speaker_mapping_from_win32(DWORD from){
...
hi_export [[nodiscard]] DWORD speaker_mapping_to_win32(speaker_mapping from) noexcept{
    auto r = DWORD{0};
