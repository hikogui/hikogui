...
keyboard_virtual_key to_keyboard_virtual_key(int key_code, bool extended, keyboard_modifiers modifiers)
{
    ...
    case VK_PAUSE: return keyboard_virtual_key::pause_break;
    case VK_ESCAPE: return keyboard_virtual_key::escape;
    case VK_SPACE: return keyboard_virtual_key::space;
    case VK_PRIOR: return keyboard_virtual_key::page_up;
    case VK_NEXT: return keyboard_virtual_key::page_down;
    ...
    case VK_PRINT: return keyboard_virtual_key::print_screen;
    case VK_SNAPSHOT: return keyboard_virtual_key::print_screen;
    case VK_INSERT: return keyboard_virtual_key::insert;
    case VK_DELETE: return keyboard_virtual_key::_delete;
    ...
    case VK_BROWSER_BACK: return keyboard_virtual_key::browser_back;
    case VK_BROWSER_FORWARD: return keyboard_virtual_key::browser_forward;
    case VK_BROWSER_REFRESH: return keyboard_virtual_key::browser_refresh;
    case VK_BROWSER_STOP: return keyboard_virtual_key::browser_stop;
    case VK_BROWSER_SEARCH: return keyboard_virtual_key::browser_search;
    case VK_BROWSER_FAVORITES: return keyboard_virtual_key::browser_favorites;
    case VK_BROWSER_HOME: return keyboard_virtual_key::browser_home;
    case VK_VOLUME_MUTE: return keyboard_virtual_key::volume_mute;
    case VK_VOLUME_DOWN: return keyboard_virtual_key::volume_down;
    case VK_VOLUME_UP: return keyboard_virtual_key::volume_up;
    case VK_MEDIA_NEXT_TRACK: return keyboard_virtual_key::media_next_track;
    case VK_MEDIA_PREV_TRACK: return keyboard_virtual_key::media_prev_track;
    case VK_MEDIA_STOP: return keyboard_virtual_key::media_stop;
    case VK_MEDIA_PLAY_PAUSE: return keyboard_virtual_key::media_play_pause;
    case VK_OEM_1: return any(modifiers & keyboard_modifiers::shift) ? keyboard_virtual_key::colon : keyboard_virtual_key::semi_colon;
    ...
    case VK_OEM_4:
        return any(modifiers & keyboard_modifiers::shift) ? keyboard_virtual_key::open_brace : keyboard_virtual_key::open_bracket;
    case VK_OEM_5: return any(modifiers & keyboard_modifiers::shift) ? keyboard_virtual_key::pipe : keyboard_virtual_key::backslash;
    case VK_OEM_6:
        return any(modifiers & keyboard_modifiers::shift) ? keyboard_virtual_key::close_brace : keyboard_virtual_key::close_bracket;
    case VK_OEM_7:
        return any(modifiers & keyboard_modifiers::shift) ? keyboard_virtual_key::double_quote : keyboard_virtual_key::quote;
    case VK_PLAY: return keyboard_virtual_key::media_play_pause;
