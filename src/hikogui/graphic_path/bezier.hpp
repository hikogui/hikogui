...
constexpr vector2
bezierTangentAt(point2 P1, point2 C, point2 P2, float t) noexcept
{
...
constexpr vector2 bezierTangentAt(
    point2 P1,
    point2 C1,
    point2 C2,
    point2 P2,
