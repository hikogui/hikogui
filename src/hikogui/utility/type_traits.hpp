 ...
 */
template<typename T>
hi_inline constexpr bool is_numeric_signed_integral_v = is_numeric_signed_integral<T>::value;
 ...
 */
template<typename T>
hi_inline constexpr bool is_numeric_unsigned_integral_v = is_numeric_unsigned_integral<T>::value;
 ...
 */
template<typename T>
hi_inline constexpr bool is_numeric_integral_v = is_numeric_integral<T>::value;
 ...
 */
template<typename T>
hi_inline constexpr bool is_numeric_v = is_numeric<T>::value;
 ...
 */
template<typename T>
hi_inline constexpr bool is_character_v = is_character<T>::value;
 ...
 */
template<typename T>
hi_inline constexpr bool is_byte_like_v = is_byte_like<T>::value;
...
template<typename T>
hi_inline constexpr bool has_value_type_v = has_value_type<T>::value;
...
template<typename T>
hi_inline constexpr bool has_add_callback_v = has_add_callback<T>::value;
