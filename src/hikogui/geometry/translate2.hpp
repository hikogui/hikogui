...
public:
    ...
    [[nodiscard]] constexpr translate2(gidentity const&) noexcept : translate2() {}
    ...
    [[nodiscard]] constexpr friend translate2 operator*(translate2 const& lhs, gidentity const&) noexcept
    {
        return lhs;
    }
