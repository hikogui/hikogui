...
hi_export_module(hikogui.formula.formula_inplace_shr_node);

hi_export namespace hi { inline namespace v1 {

hi_export struct formula_inplace_shr_node final : formula_binary_operator_node {
    formula_inplace_shr_node(size_t line_nr, size_t column_nr, std::unique_ptr<formula_node> lhs, std::unique_ptr<formula_node> rhs) :
