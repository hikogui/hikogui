...
hi_export_module(hikogui.formula.formula_decrement_node);

hi_export namespace hi { inline namespace v1 {

hi_export struct formula_decrement_node final : formula_unary_operator_node {
    formula_decrement_node(size_t line_nr, size_t column_nr, std::unique_ptr<formula_node> rhs) :
