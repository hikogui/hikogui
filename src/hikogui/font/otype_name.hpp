...
[[nodiscard]] hi_inline language_tag otype_name_get_language_tag(
...
[[nodiscard]] hi_inline language_tag
...
[[nodiscard]] hi_inline auto otype_name_get_family(std::span<std::byte const> bytes)
{
    struct return_type {
