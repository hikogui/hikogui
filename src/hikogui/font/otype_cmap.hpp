...
[[nodiscard]] hi_inline font_char_map otype_cmap_parse_map_4(std::span<std::byte const> over_sized_bytes)
{
    struct header_type {
...
[[nodiscard]] hi_inline font_char_map otype_cmap_parse_map_6(std::span<std::byte const> over_sized_bytes)
{
    struct header_type {
        big_uint16_buf_t format;
        big_uint16_buf_t length;
...
[[nodiscard]] hi_inline font_char_map otype_cmap_parse_map_12(std::span<std::byte const> over_sized_bytes)
{
    struct header_type {
        big_uint16_buf_t format;
...
[[nodiscard]] hi_inline font_char_map otype_cmap_parse(std::span<std::byte const> bytes)
{
