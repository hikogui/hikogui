...
#define HI_ASSERT_SIMD_EQ(val1, val2) ASSERT_PRED_FORMAT2(native_i32x4_tests::CmpHelperEQ, val1, val2)
#define HI_ASSERT_SIMD_NE(val1, val2) ASSERT_PRED_FORMAT2(native_i32x4_tests::CmpHelperNE, val1, val2)
