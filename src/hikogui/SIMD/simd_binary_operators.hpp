...
template<typename T, size_t N> struct simd_xor;
...
template<typename T, size_t N> struct simd_sl;
template<typename T, size_t N> struct simd_srl;
template<typename T, size_t N> struct simd_sra;
template<typename T, size_t N> struct simd_rol;
...
HI_X(simd_xor, float, 4, _mm_xor_ps);
...
HI_X(simd_xor, double, 2, _mm_xor_pd);
...
HI_X(simd_xor, int64_t, 2, _mm_xor_si128);
HI_X(simd_andnot, int64_t, 2, _mm_andnot_si128);
...
HI_X(simd_xor, int32_t, 4, _mm_xor_si128);
...
HI_X(simd_xor, int16_t, 8, _mm_xor_si128);
...
HI_X(simd_xor, int8_t, 16, _mm_xor_si128);
...
HI_X(simd_xor, uint32_t, 4, _mm_xor_si128);
...
HI_X(simd_xor, uint16_t, 8, _mm_xor_si128);
...
HI_X(simd_xor, uint8_t, 16, _mm_xor_si128);
...
HI_X(simd_xor, double, 4, _mm256_xor_si256);
...
HI_X(simd_xor, float, 8, _mm256_xor_si256);
...
HI_X(simd_xor, int64_t, 4, _mm256_xor_si256);
...
HI_X(simd_xor, int32_t, 8, _mm256_xor_si256);
...
HI_X(simd_xor, int16_t, 16, _mm256_xor_si256);
...
HI_X(simd_xor, int8_t, 32, _mm256_xor_si256);
...
HI_X(simd_xor, uint64_t, 4, _mm256_xor_si256);
...
HI_X(simd_xor, uint32_t, 8, _mm256_xor_si256);
...
HI_X(simd_xor, uint16_t, 16, _mm256_xor_si256);
...
HI_X(simd_xor, uint8_t, 32, _mm256_xor_si256);
...
HI_X(simd_add, double, 8, _mm512_add_pd);
HI_X(simd_sub, double, 8, _mm512_sub_pd);
HI_X(simd_mul, double, 8, _mm512_mul_pd);
HI_X(simd_div, double, 8, _mm512_div_pd);
HI_X(simd_or, double, 8, _mm512_or_si512);
HI_X(simd_and, double, 8, _mm512_and_si512);
HI_X(simd_xor, double, 8, _mm512_xor_si512);
HI_X(simd_andnot, double, 8, _mm512_andnot_si512);
HI_X(simd_max, double, 8, _mm512_max_pd);
HI_X(simd_min, double, 8, _mm512_min_pd);
HI_X(simd_lt, double, 8, _mm512_lt_pd);
HI_X(simd_gt, double, 8, _mm512_gt_pd);
HI_X(simd_le, double, 8, _mm512_le_pd);
HI_X(simd_ge, double, 8, _mm512_ge_pd);
HI_X(simd_eq, double, 8, _mm512_eq_pd);
HI_X(simd_ne, double, 8, _mm512_ne_pd);

HI_X(simd_add, float, 16, _mm512_add_ps);
HI_X(simd_sub, float, 16, _mm512_sub_ps);
HI_X(simd_mul, float, 16, _mm512_mul_ps);
HI_X(simd_div, float, 16, _mm512_div_ps);
HI_X(simd_or, float, 16, _mm512_or_si512);
HI_X(simd_and, float, 16, _mm512_and_si512);
HI_X(simd_xor, float, 16, _mm512_xor_si512);
HI_X(simd_andnot, float, 16, _mm512_andnot_si512);
HI_X(simd_max, float, 16, _mm512_max_ps);
HI_X(simd_min, float, 16, _mm512_min_ps);
HI_X(simd_lt, float, 16, _mm512_lt_ps);
HI_X(simd_gt, float, 16, _mm512_gt_ps);
HI_X(simd_le, float, 16, _mm512_le_ps);
HI_X(simd_ge, float, 16, _mm512_ge_ps);
HI_X(simd_eq, float, 16, _mm512_eq_ps);
HI_X(simd_ne, float, 16, _mm512_ne_ps);

HI_X(simd_add, int64_t, 8, _mm512_add_epi64);
HI_X(simd_sub, int64_t, 8, _mm512_sub_epi64);
HI_X(simd_mul, int64_t, 8, _mm512_mul_epi64);
HI_X(simd_div, int64_t, 8, _mm512_div_epi64);
HI_X(simd_or, int64_t, 8, _mm512_or_si512);
HI_X(simd_and, int64_t, 8, _mm512_and_si512);
HI_X(simd_xor, int64_t, 8, _mm512_xor_si512);
HI_X(simd_andnot, int64_t, 8, _mm512_andnot_si512);
HI_X(simd_max, int64_t, 8, _mm512_max_epi32);
HI_X(simd_min, int64_t, 8, _mm512_min_epi32);
HI_X(simd_lt, int64_t, 8, _mm512_lt_epi64);
HI_X(simd_gt, int64_t, 8, _mm512_gt_epi64);
HI_X(simd_le, int64_t, 8, _mm512_le_epi64);
HI_X(simd_ge, int64_t, 8, _mm512_ge_epi64);
HI_X(simd_eq, int64_t, 8, _mm512_eq_epi64);
HI_X(simd_ne, int64_t, 8, _mm512_ne_epi64);

HI_X(simd_add, int32_t, 16, _mm512_add_epi32);
HI_X(simd_sub, int32_t, 16, _mm512_sub_epi32);
HI_X(simd_mul, int32_t, 16, _mm512_mul_epi32);
HI_X(simd_div, int32_t, 16, _mm512_div_epi32);
HI_X(simd_or, int32_t, 16, _mm512_or_si512);
HI_X(simd_and, int32_t, 16, _mm512_and_si512);
HI_X(simd_xor, int32_t, 16, _mm512_xor_si512);
HI_X(simd_andnot, int32_t, 16, _mm512_andnot_si512);
HI_X(simd_max, int32_t, 16, _mm512_max_epi32);
HI_X(simd_min, int32_t, 16, _mm512_min_epi32);
HI_X(simd_lt, int32_t, 16, _mm512_lt_epi32);
HI_X(simd_gt, int32_t, 16, _mm512_gt_epi32);
HI_X(simd_le, int32_t, 16, _mm512_le_epi32);
HI_X(simd_ge, int32_t, 16, _mm512_ge_epi32);
HI_X(simd_eq, int32_t, 16, _mm512_eq_epi32);
HI_X(simd_ne, int32_t, 16, _mm512_ne_epi32);

HI_X(simd_add, int16_t, 32, _mm512_add_epi16);
HI_X(simd_sub, int16_t, 32, _mm512_sub_epi16);
HI_X(simd_mul, int16_t, 32, _mm512_mul_epi16);
HI_X(simd_div, int16_t, 32, _mm512_div_epi16);
HI_X(simd_or, int16_t, 32, _mm512_or_si512);
HI_X(simd_and, int16_t, 32, _mm512_and_si512);
HI_X(simd_xor, int16_t, 32, _mm512_xor_si512);
HI_X(simd_andnot, int16_t, 32, _mm512_andnot_si512);
HI_X(simd_max, int16_t, 32, _mm512_max_ps);
HI_X(simd_min, int16_t, 32, _mm512_min_ps);
HI_X(simd_lt, int16_t, 32, _mm512_lt_epi16);
HI_X(simd_gt, int16_t, 32, _mm512_gt_epi16);
HI_X(simd_le, int16_t, 32, _mm512_le_epi16);
HI_X(simd_ge, int16_t, 32, _mm512_ge_epi16);
HI_X(simd_eq, int16_t, 32, _mm512_eq_epi16);
HI_X(simd_ne, int16_t, 32, _mm512_ne_epi16);

HI_X(simd_add, int8_t, 64, _mm512_add_epi8);
HI_X(simd_sub, int8_t, 64, _mm512_sub_epi8);
HI_X(simd_mul, int8_t, 64, _mm512_mul_epi8);
HI_X(simd_div, int8_t, 64, _mm512_div_epi8);
HI_X(simd_or, int8_t, 64, _mm512_or_si512);
HI_X(simd_and, int8_t, 64, _mm512_and_si512);
HI_X(simd_xor, int8_t, 64, _mm512_xor_si512);
HI_X(simd_andnot, int8_t, 64, _mm512_andnot_si512);
HI_X(simd_max, int8_t, 64, _mm512_max_epi8);
HI_X(simd_min, int8_t, 64, _mm512_min_epi8);
HI_X(simd_lt, int8_t, 64, _mm512_lt_epi8);
HI_X(simd_gt, int8_t, 64, _mm512_gt_epi8);
HI_X(simd_le, int8_t, 64, _mm512_le_epi8);
HI_X(simd_ge, int8_t, 64, _mm512_ge_epi8);
HI_X(simd_eq, int8_t, 64, _mm512_eq_epi8);
HI_X(simd_ne, int8_t, 64, _mm512_ne_epi8);

HI_X(simd_add, uint64_t, 8, _mm512_add_epu64);
HI_X(simd_sub, uint64_t, 8, _mm512_sub_epu64);
HI_X(simd_mul, uint64_t, 8, _mm512_mul_epu64);
HI_X(simd_div, uint64_t, 8, _mm512_div_epu64);
HI_X(simd_or, uint64_t, 8, _mm512_or_si512);
HI_X(simd_and, uint64_t, 8, _mm512_and_si512);
HI_X(simd_xor, uint64_t, 8, _mm512_xor_si512);
HI_X(simd_andnot, uint64_t, 8, _mm512_andnot_si512);
HI_X(simd_max, uint64_t, 8, _mm512_max_epu64);
HI_X(simd_min, uint64_t, 8, _mm512_min_epu64);
HI_X(simd_lt, uint64_t, 8, _mm512_lt_epu64);
HI_X(simd_gt, uint64_t, 8, _mm512_gt_epu64);
HI_X(simd_le, uint64_t, 8, _mm512_le_epu64);
HI_X(simd_ge, uint64_t, 8, _mm512_ge_epu64);
HI_X(simd_eq, uint64_t, 8, _mm512_eq_epu64);
HI_X(simd_ne, uint64_t, 8, _mm512_ne_epu64);

HI_X(simd_add, uint32_t, 16, _mm512_add_epu32);
HI_X(simd_sub, uint32_t, 16, _mm512_sub_epu32);
HI_X(simd_mul, uint32_t, 16, _mm512_mul_epu32);
HI_X(simd_div, uint32_t, 16, _mm512_div_epu32);
HI_X(simd_or, uint32_t, 16, _mm512_or_si512);
HI_X(simd_and, uint32_t, 16, _mm512_and_si512);
HI_X(simd_xor, uint32_t, 16, _mm512_xor_si512);
HI_X(simd_andnot, uint32_t, 16, _mm512_andnot_si512);
HI_X(simd_max, uint32_t, 16, _mm512_max_epu32);
HI_X(simd_min, uint32_t, 16, _mm512_min_epu32);
HI_X(simd_lt, uint32_t, 16, _mm512_lt_epu32);
HI_X(simd_gt, uint32_t, 16, _mm512_gt_epu32);
HI_X(simd_le, uint32_t, 16, _mm512_le_epu32);
HI_X(simd_ge, uint32_t, 16, _mm512_ge_epu32);
HI_X(simd_eq, uint32_t, 16, _mm512_eq_epu32);
HI_X(simd_ne, uint32_t, 16, _mm512_ne_epu32);

HI_X(simd_add, uint16_t, 32, _mm512_add_epi16);
HI_X(simd_sub, uint16_t, 32, _mm512_sub_epi16);
HI_X(simd_mul, uint16_t, 32, _mm512_mul_epu16);
HI_X(simd_div, uint16_t, 32, _mm512_div_epu16);
HI_X(simd_or, uint16_t, 32, _mm512_or_si512);
HI_X(simd_and, uint16_t, 32, _mm512_and_si512);
HI_X(simd_xor, uint16_t, 32, _mm512_xor_si512);
HI_X(simd_andnot, uint16_t, 32, _mm512_andnot_si512);
HI_X(simd_max, uint16_t, 32, _mm512_max_epu16);
HI_X(simd_min, uint16_t, 32, _mm512_min_epu16);
HI_X(simd_lt, uint16_t, 32, _mm512_lt_epu16);
HI_X(simd_gt, uint16_t, 32, _mm512_gt_epu16);
HI_X(simd_le, uint16_t, 32, _mm512_le_epu16);
HI_X(simd_ge, uint16_t, 32, _mm512_ge_epu16);
HI_X(simd_eq, uint16_t, 32, _mm512_eq_epu16);
HI_X(simd_ne, uint16_t, 32, _mm512_ne_epu16);

HI_X(simd_add, uint8_t, 64, _mm512_add_epi8);
HI_X(simd_sub, uint8_t, 64, _mm512_sub_epi8);
HI_X(simd_mul, uint8_t, 64, _mm512_mul_epu8);
HI_X(simd_div, uint8_t, 64, _mm512_div_epu8);
HI_X(simd_or, uint8_t, 64, _mm512_or_si512);
HI_X(simd_and, uint8_t, 64, _mm512_and_si512);
HI_X(simd_xor, uint8_t, 64, _mm512_xor_si512);
HI_X(simd_andnot, uint8_t, 64, _mm512_andnot_si512);
HI_X(simd_max, uint8_t, 64, _mm512_max_epu8);
HI_X(simd_min, uint8_t, 64, _mm512_min_epu8);
HI_X(simd_lt, uint8_t, 64, _mm512_lt_epu8);
HI_X(simd_gt, uint8_t, 64, _mm512_gt_epu8);
HI_X(simd_le, uint8_t, 64, _mm512_le_epu8);
HI_X(simd_ge, uint8_t, 64, _mm512_ge_epu8);
HI_X(simd_eq, uint8_t, 64, _mm512_eq_epu8);
HI_X(simd_ne, uint8_t, 64, _mm512_ne_epu8);
#endif
