...
#define HI_ASSERT_SIMD_EQ(val1, val2) ASSERT_PRED_FORMAT2(native_i64x4_tests::CmpHelperEQ, val1, val2)
#define HI_ASSERT_SIMD_NE(val1, val2) ASSERT_PRED_FORMAT2(native_i64x4_tests::CmpHelperNE, val1, val2)

using S = hi::native_simd<int64_t,4>;
using A = S::array_type;

TEST(native_i64x4, construct)
{
    {
