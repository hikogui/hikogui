...
export module hikogui_concurrency_subsystem;
import hikogui_concurrency_global_state;
import hikogui_concurrency_unfair_recursive_mutex;
...
hi_no_inline bool start_subsystem(global_state_type state_bit, bool (*init_function)(), void (*deinit_function)())
{
