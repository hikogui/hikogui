 ...
 */
export [[nodiscard]] inline generator<std::filesystem::path> glob(glob_pattern pattern) noexcept
{
 ...
 * @return a generator yielding paths to objects on the filesystem that match the pattern.
 */
export [[nodiscard]] inline generator<std::filesystem::path> glob(std::string_view pattern) noexcept
{
 ...
 * @return a generator yielding paths to objects on the filesystem that match the pattern.
 */
export [[nodiscard]] inline generator<std::filesystem::path> glob(std::string pattern) noexcept
{
 ...
 * @return a generator yielding paths to objects on the filesystem that match the pattern.
 */
export [[nodiscard]] inline generator<std::filesystem::path> glob(char const *pattern) noexcept
{
    return glob(glob_pattern{pattern});
}
 ...
 * @return a generator yielding paths to objects on the filesystem that match the pattern.
 */
export [[nodiscard]] inline generator<std::filesystem::path> glob(std::filesystem::path pattern) noexcept
{
    return glob(glob_pattern{std::move(pattern)});
}
