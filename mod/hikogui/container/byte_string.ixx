...
export module hikogui_container_byte_string;
...
[[nodiscard]] bstring to_bstring(std::string_view src) noexcept
{
    return bstring{reinterpret_cast<std::byte const *>(src.data()), src.size()};
}

[[nodiscard]] bstring to_bstring(std::integral auto... args) noexcept
{
