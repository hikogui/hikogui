...
export using gstring = std::basic_string<grapheme>;
export using gstring_view = std::basic_string_view<grapheme>;

namespace pmr {
export using gstring = std::pmr::basic_string<grapheme>;
}
...
export [[nodiscard]] constexpr gstring set_language(gstring str, language_tag language) noexcept
{
...
export [[nodiscard]] constexpr gstring fix_language(gstring str, language_tag default_language_tag) noexcept
{
 ...
 */
export [[nodiscard]] constexpr std::string to_string(gstring_view rhs) noexcept
{
    auto r = std::string{};
    r.reserve(rhs.size());
    for (hilet c : rhs) {
 ...
 */
export [[nodiscard]] constexpr std::wstring to_wstring(gstring_view rhs) noexcept
{
    auto r = std::wstring{};
    r.reserve(rhs.size());
    for (hilet c : rhs) {
 ...
 */
export [[nodiscard]] constexpr std::u32string to_u32string(gstring_view rhs) noexcept
{
 ...
 * @return The resulting UTF-32 string, in NFC normalization.
 */
export [[nodiscard]] constexpr std::string to_string(gstring const& rhs) noexcept
{
