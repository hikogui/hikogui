...
export module hikogui_utility_time_zone;
...
[[nodiscard]] std::chrono::time_zone const *_cached_current_zone() noexcept
{
    try {
 ...
 * on the system.
 */
[[nodiscard]] std::chrono::time_zone const& cached_current_zone() noexcept
{
