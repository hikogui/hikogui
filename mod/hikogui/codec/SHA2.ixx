...
export class SHA224 final : public SHA2<uint32_t, 224> {
public:
    SHA224() noexcept :
...
export class SHA256 final : public SHA2<uint32_t, 256> {
public:
    SHA256() noexcept :
...
export class SHA384 final : public SHA2<uint64_t, 384> {
public:
    SHA384() noexcept :
        SHA2<uint64_t, 384>(
            0xcbbb9d5dc1059ed8,
...
export class SHA512 final : public SHA2<uint64_t, 512> {
public:
    SHA512() noexcept :
        SHA2<uint64_t, 512>(
            0x6a09e667f3bcc908,
...
export class SHA512_224 final : public SHA2<uint64_t, 224> {
public:
    SHA512_224() noexcept :
        SHA2<uint64_t, 224>(
            0x8C3D37C819544DA2,
...
export class SHA512_256 final : public SHA2<uint64_t, 256> {
public:
    SHA512_256() noexcept :
        SHA2<uint64_t, 256>(
            0x22312194FC2BF72C,
