...
export [[nodiscard]] constexpr access_mode operator|(access_mode const& lhs, access_mode const& rhs) noexcept
{
...
export [[nodiscard]] constexpr bool to_bool(access_mode const& rhs) noexcept
{
