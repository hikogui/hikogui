...
public:
     ...
     *  - `alignment::top_left`: icon and text are with each other, with
     *    the icon in the top-left corner.
     *  - `alignment::top_right`: icon and text are with each other, with
     *    the icon in the top-right corner.
     *  - `alignment::middle_left`: icon and text are with each other, with
     *    the icon in the middle-left.
     *  - `alignment::middle_right`: icon and text are with each other, with
     *    the icon in the middle-right.
     *  - `alignment::bottom_left`: icon and text are with each other, with
     *    the icon in the bottom-left.
     *  - `alignment::bottom_right`: icon and text are with each other, with
