...
import hikogui_i18n_iso_15924;
import hikogui_i18n_iso_3166;
...
public:
    ...
    [[nodiscard]] std::vector<language_tag> all_variants() const noexcept
    {
        ...
        for (auto const variant : variants()) {
            for (auto const expanded_variant : variant.expand().variants()) {
 ...
 */
export [[nodiscard]] std::vector<language_tag> variants(std::vector<language_tag> languages);
