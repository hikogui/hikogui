...
export constexpr font_weight& operator++(font_weight& rhs) noexcept
{
 ...
 */
export [[nodiscard]] constexpr font_weight font_weight_from_int(numeric_integral auto rhs)
{
...
export [[nodiscard]] constexpr std::string_view to_string_view(font_weight const& x) noexcept
{
    return font_weight_metadata[x];
}

export [[nodiscard]] constexpr std::string to_string(font_weight const& x) noexcept
{
    return std::string{to_string_view(x)};
}

export [[nodiscard]] constexpr char to_char(font_weight const& x) noexcept
{
...
export [[nodiscard]] constexpr int to_int(font_weight const& x) noexcept
{
...
export constexpr bool almost_equal(font_weight const& lhs, font_weight const& rhs) noexcept
{
