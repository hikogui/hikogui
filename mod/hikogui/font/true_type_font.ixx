...
export module hikogui_font_true_type_font;
import hikogui_file_file_view;
import hikogui_font_font;
import hikogui_font_font_char_map;
import hikogui_font_maxp;
import hikogui_font_otype_cmap;
import hikogui_font_otype_glyf;
import hikogui_font_otype_head;
import hikogui_font_otype_hhea;
import hikogui_font_otype_htmx;
import hikogui_font_otype_kern;
import hikogui_font_otype_loca;
import hikogui_font_otype_name;
import hikogui_font_otype_os2;
import hikogui_font_otype_sfnt;
...
export class true_type_font final : public font {
public:
